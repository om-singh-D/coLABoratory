    ...
    <div className="flex flex-col h-full bg-white relative">
      <div className="flex items-center justify-between px-3 py-1.5 bg-gray-100 border-b border-gray-300">
        <div className="flex items-center gap-2">
          ...
          <div className="ml-2 px-3 py-0.5 bg-white rounded border border-gray-200 text-xs text-gray-600 flex items-center gap-2 min-w-[200px] max-w-[300px] truncate">
        ...
        {url && (
          <a 
            ...
            className="text-gray-500 hover:text-blue-500 p-1 rounded hover:bg-gray-200 transition-colors"
